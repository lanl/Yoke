...
model, checkpoint = tr.load_model_and_optimizer(model_filepath+model_name+'.pth', optimizer, available_models, device=device)




# load data, one data point needed to get structure of model to save on onnx format
