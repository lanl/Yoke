...
def create_test_npz(file_path, shape=(10, 10)):
...
def test_load_sim_data_reads_npz():
...
def test_extract_densities_returns_expected_means():
...
def test_generate_contour_plot_creates_file():
