...
from yoke.datasets.lsc_dataset import LSCnpz2key, LSC_cntr2hfield_DataSet
...
model = tCNNsurrogate(
    ...
    nfeature_list=args.nfeatureList,
    output_image_size=(1120, 800),
    act_layer=nn.GELU,
)
...
# Load dataset
################
eval_dataset = LSC_cntr2hfield_DataSet(args.LSC_NPZ_DIR, eval_filelist, design_file)
