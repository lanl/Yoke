...
def main():
    ...
    default=f"runs/study_0{study}/training_study0{study}_epoch*.csv",
    )
    ...
    parser.add_argument(
        ...
        default=f"runs/study_0{study}/validation_study0{study}_epoch*.csv",
    )

    parser.add_argument(
        "--out",
        type=str,
        default=f"loss_curves_study0{study}.png",
    )
