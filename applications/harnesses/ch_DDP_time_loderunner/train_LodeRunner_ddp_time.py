...
#############################################
descr_str = (
    "Uses DDP to train LodeRunner architecture on single- or multi-timestep input and output "
...
# Add argument manually (no helper function available)
parser.add_argument(
    "--max_timeIDX_offset",
    type=int,
    default=2,
    help="Offset for the maximum time index used in dataset creation."
)
