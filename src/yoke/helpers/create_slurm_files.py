...
class MkSlurm:
    ...
    def generateSlurm(self) -> str:
        ...
        if 'generated-params' in self._config and \
            'run-config' in self._config['generated-params']:
        ...
        if 'generated-params' in self._config and \
            'log' in self._config['generated-params']:
        ...
        if 'generated-params' in self._config and \
            'email' in self._config['generated-params']:
        ...
        if 'generated-params' in self._config and \
            'verbose' in self._config['generated-params']:
        ...
        slurm_args_string = ''.join([generateSingleRowSlurm(k, slurm_arg_params[k])
                                     for k in slurm_arg_params]) + verbose_slurm_lines
